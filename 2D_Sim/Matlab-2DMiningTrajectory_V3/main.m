...
vel = (P.d_max/10)*stepFactor;
om  = 0.05*degToRad*stepFactor;

pause_time = 0.0001;
N = round((P.d_max/vel)*numCycles);
%***********************************
%-----------------------------------
%***********************************
...
%Plot centroid path
plot(x,y,'b.');
title(['Mining bot front body trajectory. vel = ',num2str(vel),' in/step, om = ',num2str(om/degToRad),' deg/step']);
